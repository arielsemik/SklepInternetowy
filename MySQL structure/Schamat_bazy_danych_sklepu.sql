...
INSERT INTO `order_header` VALUES (000001,000002,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2019-04-15 22:04:29','Wysłane','2019-04-16 22:14:54',NULL),(000002,000002,'PIEKNA 22','ŁUKÓW','21-400',NULL,NULL,NULL,'2456789898','2019-04-15 23:14:11','Nowe','2019-04-16 22:14:54',NULL);
...
CREATE TABLE `order_lines` (
  ...
  `order_id_fk` int(6) unsigned zerofill NOT NULL,
...
INSERT INTO `order_lines` VALUES (000000000001,000001,'słuchawki01',6,'szt','Wysłane'),(000000000002,000001,'słuchawki02',6,'szt','Wysłane');
...
CREATE TABLE `products` (
  ...
  `image` text,
  `category_id` int(6) unsigned zerofill DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `products` VALUES (000001,'słuchawki01',NULL,300,NULL,NULL),(000002,'słuchawki02',NULL,300,NULL,NULL);
...
INSERT INTO `users` VALUES (000001,'Ariel','Semik','semikariel@gmail.com',NULL,'Admin','Długa 5','Warszawa','00-100','12345as','2019-04-15 22:05:22'),(000002,'Piotr','Franciszek','piotrfranciszek@gmail.com',NULL,'Customer','Mała 5','Warszawa','00-100','12345as','2019-04-15 22:05:22');
...
-- Dump completed on 2019-04-17 21:50:00
